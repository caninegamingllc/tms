...
export default async function AdminAccountingPage({
  ...
  return (
    <>
      ...
      <form action={updateAccountingSettings} className="grid gap-6">
        <section className="card">
          <h2 className="section-title">Export Method</h2>
          <p className="muted">
            The Accounting screens show export status for the selected method only. Switching methods does not
            erase previous IIF or Online export records.
          </p>
          ...
          <div className="mt-4 grid gap-3">
            <label className="flex items-start gap-3 rounded-2xl border border-border p-4">
              ...
              <span>
                ...
                <span className="muted block">Hide QuickBooks export actions until a method is chosen.</span>
              </span>
            </label>
            <label className="flex items-start gap-3 rounded-2xl border border-border p-4">
              <input
        ...
        <section className="card">
          <h2 className="section-title">Account Mapping</h2>
          <p className="muted">
            Names must match accounts (and optional items) that already exist in your QuickBooks company file.
          </p>
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            ...
            <label className="grid gap-2">
              ...
              <input name="freightIncome" className="input" defaultValue={config.freightIncome} required />
            </label>
            <label className="grid gap-2">
      ...
      <section className="card mt-6">
        <h2 className="section-title">QuickBooks Online Connection</h2>
        <p className="muted">
          Status:{" "}
        ...
        {!qboConfigured ? (
          <p className="mt-3 text-sm text-amber-800">
            Set INTUIT_CLIENT_ID, INTUIT_CLIENT_SECRET, and INTUIT_TOKEN_ENCRYPTION_KEY in the environment to
            enable OAuth.
          </p>
        ) : null}
